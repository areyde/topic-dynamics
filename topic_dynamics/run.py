...
from .tokenizer.identifiers_extractor.language_recognition.utils import main as initialize_enry
from .tokenizer.identifiers_extractor.parsers.utils import main as initialize_parser
